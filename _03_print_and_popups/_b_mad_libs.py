...
if __name__ == '__main__':
    ...
    lqd = simpledialog.askstring(title="Question", prompt="Enter a liquid")
    # Get the player to enter a body part
    bdyprt = simpledialog.askstring(title='Question', prompt="Enter a body part")
    # Get the player to enter a verb
    vrb = simpledialog.askstring(title="Question", prompt="Enter a verb")
    # Get the player to enter a place
    plc = simpledialog.askstring(title="Question", prompt="Enter a place")
    ...
    story = (
        ...
        "night. Piranhas are attracted to fresh " + lqd + " and will most\n"
        "likely take a bite out of your " + bdyprt + " if you " + vrb + ". Whatever\n"
